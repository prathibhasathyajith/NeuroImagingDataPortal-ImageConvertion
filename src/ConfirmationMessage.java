...
public class ConfirmationMessage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnok, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, -1, -1));

        btncancel.setFont(new java.awt.Font("Avenir", 0, 14)); // NOI18N
        ...
        getContentPane().add(btncancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, -1, -1));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/messageSmall.png"))); // NOI18N
    ...
    private void btncancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancelActionPerformed
        ...
        x=1;
        returnv();
        System.out.println("in-inside-" + x);
